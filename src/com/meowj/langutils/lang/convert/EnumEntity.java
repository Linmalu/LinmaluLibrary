...
public enum EnumEntity
{
	...
	static
	{
		EnumSet.allOf(EnumEntity.class).forEach(entity -> lookup.put(entity.getType(), entity));
	}
	...
	{
		return lookup.containsKey(entityType) ? LinmaluLanguage.translateToName(lookup.get(entityType).unlocalizedName) : null;
	}
	 ...
	 */
	public static String getSpawnEggName(ItemStack egg)
	{
		...
		String first = LinmaluLanguage.translateToName("item.monsterPlacer.name");
		return name != null && first != null ? first + " " + name :  LinmaluLanguage.translateToName("item.monsterPlacer.name");
	}
	 ...
	 *
	 * @param egg
	 *            The monster egg to be processed.
	 * @return the {@link org.bukkit.entity.EntityType} of the monster egg.
	 * @throws ClassNotFoundException
	 *             when CraftItemStack is not found.
	 * @throws NoSuchMethodException
	 *             when either of asNMSCopy(), getTag(), getCompound(), getString() is not found.
	 * @throws InvocationTargetException
	 *             when either method throws an exception.
	 * @throws IllegalAccessException
	 *             when does not have access to these methods.
	 */
