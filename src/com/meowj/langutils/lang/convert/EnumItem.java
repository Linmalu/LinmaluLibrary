...
public enum EnumItem
{
	...
	static
	{
		EnumSet.allOf(EnumItem.class).forEach(item -> lookup.put(new ItemEntry(item.material, item.getMetadata()), item));
	}
	...
	public static String get(ItemStack item)
	{
		...
		{
			return LinmaluLanguage.translateToName(lookup.get(entry).unlocalizedName);
		}
		else
		{
			entry = new ItemEntry(entry.getMaterial());
			if(lookup.containsKey(entry))
			{
				return LinmaluLanguage.translateToName(lookup.get(entry).unlocalizedName);
			}
	...
	public static String getPlayerSkullName(ItemStack skull)
	{
		SkullMeta meta = (SkullMeta)skull.getItemMeta();
		if(meta.hasOwner())
		{
			String result = LinmaluLanguage.translateToName("item.skull.player.name");
			return result != null ? String.format(result, meta.getOwner()) : null;
		}
		else
		{
			return LinmaluLanguage.translateToName("item.skull.char.name");
		}
	}
