...
public enum EnumEnchantment
{
	...
	static
	{
		EnumSet.allOf(EnumEnchantment.class).forEach(enchantment -> lookup.put(enchantment.enchantment, enchantment));
	}
	...
	{
		return lookup.containsKey(enchantment) ? LinmaluLanguage.translateToName(lookup.get(enchantment).unlocalizedName) : null;
	}
